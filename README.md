...
**Measured → Calculated:**
- QPO frequency: 96.7 Hz (detected, SNR=22)
- → r_ISCO = 1.55 r_g
- → **Spin a* = 0.9845**
- Known spin: a* = 0.98
- **Error: 0.45%**
...
|--------|--------|-----------|-------|
| **DEMON (QPO→ISCO→Spin)** | **a* = 0.9845** | - | - |
| Continuum fitting | a* = 0.98 | McClintock 2006 | - |
| Fe K-alpha line | a* = 0.98 | Miller 2013 | - |
| **Difference** | - | - | **0.45%** |
...
**Измерено → Рассчитано:**
- Частота QPO: 96.7 Hz (детектирована, SNR=22)
- → r_ISCO = 1.55 r_g
- → **Спин a* = 0.9845**
...
|-------|-----------|----------|--------|
| **DEMON (QPO→ISCO→Spin)** | **a* = 0.9845** | - | - |
| Континуум-фитинг | a* = 0.98 | McClintock 2006 | - |
| Линия Fe K-alpha | a* = 0.98 | Miller 2013 | - |
| **Разница** | - | - | **0.45%** |
